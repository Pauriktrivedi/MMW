...
def compute_and_plot_department_spend(dframe: pd.DataFrame, top_n: int = 15):
    ...
    # Top N departments (aggregate subcategories under same main dept if you want overall by main dept)
    main_dept_agg = (
    ...
    # Also show breakdown by Sub Category for the top departments
